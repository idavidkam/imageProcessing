...
public class Lamp {
    ...
    public Lamp(Color color, Color lampShadeColor, double radius,double radius1,double diameterWire,double heightWire ,SpotLight lightLamp,Vector v1, Vector v2) {
        ...
        Point3D pCord1=p1.add(v2.scale(diameterWire));
        Point3D pCord2=p1.add(v2.scale(-diameterWire));
        Point3D pCord3=p1.add(v3.scale(diameterWire));
        Point3D pCord4=p1.add(v3.scale(-diameterWire));
