...
public class RayTracerBox extends RayTracerBasic {
	...
	protected GeoPoint findClosestIntersection(Ray ray) {		
		List<GeoPoint> closestPoints = scene.box.findIntersectionsInTheBox(ray, false, Double.POSITIVE_INFINITY);
	...
	protected double transparency(LightSource light, Vector l, Vector n, GeoPoint gp) {
		...
		List<GeoPoint> intersections =  scene.box.findIntersectionsInTheBox(lightRay, true, lightDistance);
