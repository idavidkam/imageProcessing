...
public class ShadowTests {
	...
	public void sphereTriangleSpot1() {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-90, -90, 175), new Vector(1, 1, -3)) //
						.setKl(1E-5).setKq(1.5E-7));

		Render render = new Render(). //
				setImageWriter(new ImageWriter("sphereTriangleSpot1", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	public void sphereTriangleSpot2() {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-80, -80, 115), new Vector(1, 1, -3)) //
						.setKl(1E-5).setKq(1.5E-7));
